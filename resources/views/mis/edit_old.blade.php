                        ...
                        <div class="row g-3">
                            <div class="col-12 col-lg-4">
                                ...
                                <select class="form-select" name="lease_type" id="TypeLease" aria-label="Type of Lease">
                                    ...
                                    <option value="{{$leaseType->id}}" {{$propertyLeaseDetail->type_of_lease ==
        $leaseType->id ? 'selected' : ''}} >{{ $leaseType->item_name }}</option>
                                    @endforeach
                                </select>
                                @error('lease_type')
                                <span class="errorMsg">{{ $message }}</span>
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <input type="text" name="lease_no" class="form-control" id="LeaseAllotmentNo"
                                    placeholder="Lease/Allotment No." value="{{ $propertyLeaseDetail->lease_no }}">
                                @error('lease_no')
                                <span class="errorMsg">{{ $message }}</span>
                                @enderror
                                        ...
                                        <div class="items">
                                            ...
                                            <div class="item-content">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="original[{{$originalData->id}}]" placeholder="Name" data-name="name"
...
$count = 1;
                                                @endphp
                                                @foreach($filteredTransferDetails as $key => $TransferDetail)
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12 col-lg-4 my-4">
                                                            ...
                                                            <select name="land_transfer_type[]"
                                                                ...
                                                                <option value="">Select</option>
                                                                <option value="Substitution" {{$key == 'Substitution'
        ? 'selected' : '' }}>Substitution</option>
                                                                <option value="Mutation" {{$key == 'Mutation' ? 'selected'
        : '' }}>Mutation</option>
                                                                <option value="Substitution cum Mutation"
                                                                    {{$key == 'Substitution cum Mutation' ? 'selected'
        : '' }}>Substitution cum Mutation</option>
                                                                <option value="Successor in interest"
                                                                    {{$key == 'Successor in interest' ? 'selected' : ''
                                                                    }}>Successor in interest</option>
                                                                <option value="Others" {{$key == 'Others' ? 'selected'
        : '' }}>Others</option>
                                                            </select>
                                                        ...
                                                        <div class="col-12 col-lg-4 my-4">
                                                            ...
                                                            <input type="date" name="transferDate[]"
                                                                ...
                                                                value="{{$TransferDetail[0]->transferDate}}"
                                                                id="transferredDate">
                                                            <div id="transferredDateError" class="text-danger"></div>
                                                        </div>
                                                    </div>
                                                    @foreach($TransferDetail as $key => $detail)
                                                    <div class="child-item">
                                                        <div class="duplicate-field-tab">
                                                            <div class="items1" data-group="test">
                                                                <div class="item-content row">
                                                                    <input type="hidden" value="{{$detail->id}}" name="id{{$count}}[]" />
                                                                    ...
                                                                    <div class="col-lg-4 mb-3">
                                                                        ...
                                                                        <input type="number" name="age{{$count}}[]"
                                    ...
                                    <div class="freehold-container" id="freeHoldContainer">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <label for="ConveyanceDate" class="form-label">Date of
                                                ...
                                                @if($conversion)
                                            <input type="date" value="{{$conversion[0]->transferDate}}" class="form-control" name="conveyanc_date"
                                                id="ConveyanceDate">
                                                @endif
                                        </div>
                                                        ...
                                                        <!-- <div class="item-content">
                                                            ...
                                                            <div class="mb-3 col-lg-8 col-12">
                                                                ...
                                                                <input type="text" name="conversion[{{$conver->id}}]"
                                                                    ...
                                                                    placeholder="Name" data-name="name" value="{{$conver->lessee_name}}">
                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <select class="form-select" id="TypeLease" name="in_possession_of"
                                                    aria-label="Type of Lease">
                                                    <option value="">Select</option>
                                                    <option value="1" {{$propertyLeaseDetail->in_possession_of_if_vacant == 1 ? 'checked' : ''}} >DDA</option>
                                                    <option value="2" {{$propertyLeaseDetail->in_possession_of_if_vacant == 2 ? 'checked' : ''}}>NDMC</option>
                                                    <option value="3" {{$propertyLeaseDetail->in_possession_of_if_vacant == 3 ? 'checked' : ''}}>MCD</option>
                                                </select>
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <input type="date" class="form-control" name="date_of_transfer"
                                                    id="dateTransfer" value="{{$propertyLeaseDetail->date_of_transfer}}">
                                            </div>
                                        </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="form-check mr-2">
                                            <input class="form-check-input" type="radio" name="landTypeOthers"
                                                value="Yes" id="landTypeFormOthersYes" {{$propertyDetail->status == 1342 ? 'checked' : ''}}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="landTypeOthers"
                                                value="No" id="landTypeFormOthersNo" {{$propertyDetail->status != 1342 ? 'checked' : ''}}>
                                ...
                                <div class="col-lg-12">
                                    <div class="landType-container row" id="landTypeOthersContainer">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            ...
                                            <input type="text" class="form-control" id="remarks" name="remark" value="{{$propertyLeaseDetail->remarks}}">
                                        </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-lg-12">
                                ...
                                <input type="date" class="form-control" id="lastInsReport"
                                    name="date_of_last_inspection_report" value="{{$propertyInspectionDemandDetail ? $propertyInspectionDemandDetail->last_inspection_ir_date : ''}}">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="date" class="form-control" name="date_of_last_demand_letter"
                                    id="LastDemandLetter" value="{{$propertyInspectionDemandDetail ? $propertyInspectionDemandDetail->last_demand_letter_date : ''}}" >
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="number" class="form-control" name="demand_id" id="DemandID"
                                    placeholder="Demand ID" value="{{$propertyInspectionDemandDetail ? $propertyInspectionDemandDetail->last_demand_id : ''}}">
                            ...
                            <div class="col-12 col-lg-12">
                                ...
                                <input type="text" name="amount_of_last_demand" class="form-control"
                                    id="amountDemandLetter" value="{{$propertyInspectionDemandDetail ? $propertyInspectionDemandDetail->last_demand_amount : ''}}">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="LastAmount" name="last_amount_reveived"
                                    placeholder="Last Amount Received" value="{{$propertyInspectionDemandDetail ? $propertyInspectionDemandDetail->last_amount_received : ''}}">
                                <div id="LastAmountError" class="text-danger"></div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <label for="lastamountdate" class="form-label">Date</label>
                                <input type="date" class="form-control" name="last_amount_date" id="lastamountdate" value="{{$propertyInspectionDemandDetail ? $propertyInspectionDemandDetail->last_amount_received_date : ''}}">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-lg-12">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-check mr-2">
                                        <input class="form-check-input" type="radio" name="GR" value="1" id="GRFormYes" {{$propertyMiscDetail->is_gr_revised_ever == 1 ? 'checked' : ''}}>
                                        <label class="form-check-label" for="GRFormYes">
                                            <h6 class="mb-0">Yes</h6>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="GR" value="0" id="GRFormNo" {{$propertyMiscDetail->is_gr_revised_ever == 0 ? 'checked' : ''}} >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="date" class="form-control" name="supplementary_date"
                                                id="SupplementaryDate" value="{{$propertyMiscDetail->supplimentry_lease_deed_executed_date}}">
                                        </div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="Reentered-container row" id="ReenteredContainer">
                                    ...
                                    <div class="col-12 col-lg-4">
                                        ...
                                        <input type="date" class="form-control" id="reentryDate" name="date_of_reentry" value="{{$propertyMiscDetail->re_rented_date}}">
                                    </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div id="test-vl-7" role="tabpane3" class="bs-stepper-pane content fade"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <input type="email" name="email" class="form-control" id="Email" placeholder="Email" value="{{$propertyContactDetail->email}}">
...
$istTime = $utcTime->setTimezone('Asia/Kolkata');
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <input type="date" name="date" class="form-control" id="asondate" value="{{$istTime->format('Y-m-d')}}">
