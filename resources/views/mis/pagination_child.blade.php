		...
		<td>
			<div class="d-flex gap-3">
				<a href="{{ url('property-details/' . $propertyDetail->id . '/view') }}""> <button type=" button"
					...
					<button type=" button" data-bs-toggle="modal" data-bs-target="#deleteProperty_{{$propertyDetail->id}}" class="btn btn-danger px-5">Delete</button>
					<div class="modal fade" id="deleteProperty_{{$propertyDetail->id}}" tabindex="-1" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								...
								<div class="modal-body">Do you really want to delete this property? <br>This process cannot be undone. </div>
								<div class="modal-footer">
									<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
