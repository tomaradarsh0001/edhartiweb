...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3" id="smsCreateForm" method="post" action="{{route('settings.whatsapp.update',$configuration->id)}}">
            @csrf
            @method('PUT')
            @csrf
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control required-for-sms-setting-create" id="whatsappVendor"
                    name="whatsappVendor" placeholder="Sms Vendor" value="{{$configuration->vendor}}">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control required-for-sms-setting-create" id="whatsappNumber"
                    name="whatsappNumber" placeholder="Whatsapp From" value="{{$configuration->whatsapp_number}}">
