...
@section('content')
    ...
    <div class="modal fade" id="transferPropertyModel" tabindex="-1" aria-labelledby="transferPropertyModelLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="propertyTransferForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="transferPropertyId" name="transferPropertyId" required>
                </div>
