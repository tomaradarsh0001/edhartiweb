                        ...
                        <div class="col-lg-12 col-12">
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="flatNumber" id="flatNumber"
                                        ...
                                        value="{{ isset($flatData->flat_number) ? $flatData->flat_number : old('flatNumber') }}" maxlength="10">
                                    @error('flatNumber')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                        ...
                                        <select class="form-select unit-dropdown" id="unit" aria-label="Select Unit"
                                            ...
                                            @foreach ($areaUnit[0]->items as $unit)
                                                <option value="{{ $unit->id }}"
                                                    @if ($flatData->unit == $unit->id) @selected(true) @endif>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control name-field" name="nameofBuilder" id="nameofBuilder"
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control name-field" name="originalBuyerName"
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" class="form-control prasent-occupant" name="presentOccupantName"
