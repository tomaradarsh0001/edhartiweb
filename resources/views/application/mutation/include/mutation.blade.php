    ...
    <div class="container-fluid">
        ...
        <div class="row g-2">
            ...
            <div class="form-group">
                    ...
                    <div class="mix-field">
                        <input type="date" id="mutDateOfBirth" name="dateOfBirth"
                            max="{{ date('Y-m-d') }}" class="form-control" readonly />
                        <div class="age-box">
                            <h4>Age: </h4>
                            <input type="text" id="mutAge" name="age"
            ...
            <div class="col-lg-4">
                <label for="mutFathernameApp" class="form-label">S/o, D/o, Spouse Of</label>
        ...
        <div class="row g-2 mt-2">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutNameAsConLease" class="form-control alpha-only" id="namergapp" placeholder="Executed in favour of" value="{{ isset($application) ? $application->name_as_per_lease_conv_deed : '' }}" readonly>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutRegnoAsConLease" maxlength="30" class="form-control numericOnly" id="regno" placeholder="Registration No." value="{{ isset($application) ? $application->reg_no_as_per_lease_conv_deed : '' }}">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutBooknoAsConLease" maxlength="10" class="form-control numericOnly" id="bookno" placeholder="Book No." value="{{ isset($application) ? $application->book_no_as_per_lease_conv_deed : '' }}">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="mutVolumenoAsConLease" maxlength="10" class="form-control numericOnly" id="volumeno" placeholder="Volume No." value="{{ isset($application) ? $application->volume_no_as_per_lease_conv_deed : '' }}">
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <div class="row merge-inputs">
                        <div class="col-lg-6">
                            <input type="text" name="mutPagenoFrom" maxlength="4" class="form-control numericDecimalHyphen" id="pagenoFrom" placeholder="From" value="{{ $num1 }}">
                            <div id="pagenoFromError" class="text-danger text-left"></div>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" name="mutPagenoTo" maxlength="4" class="form-control numericDecimalHyphen" id="pagenoTo" placeholder="To" value="{{ $num2 }}">
        ...
        <div class="row g-2">
            ...
            <div>
                <h6 class="mr-5 mb-3">Select Documents (Select at least one)</h6>
                <div class="d-flex align-items-center gap-3 flex-wrap ">
                    @foreach($documentTypes as $document)
                    <div class="form-check form-check-success">
                        @if(isset($application))
                        <input class="form-check-input documentType" type="checkbox" value="{{$document->item_code}}" id="{{$document->color_code}}_check" @if(in_array($document->item_code, $decodedDocuments)) checked @endif >
                        @else
                        <input class="form-check-input documentType" type="checkbox" value="{{$document->item_code}}" id="{{$document->color_code}}_check">
                        @endif
        ...
        <div class="row g-3 align-items-end mt-3">
            ...
            <div class="col-lg-6" id="mortgagedMainDivMutation" style="display: none;">
            ...
            <div id="yesRemarksDiv" style="{{ isset($application) && $application->property_stands_mortgaged == 1 ? '' : 'display:none' }}">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="remarks" class="form-label">Remark<span class="text-danger">*</span> (Mention details of NOC from mortgaged bank/ authority, submit original NOC at the time of proof reading. )</label>
                        <textarea class="form-control" name="mutMortgagedRemarks" id="remarks" placeholder="Remark">{{isset($application) && $application->mortgaged_remark ? $application->mortgaged_remark: ''}}</textarea>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div id="YesCourtOrderMutationError" class="text-danger text-left"></div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
