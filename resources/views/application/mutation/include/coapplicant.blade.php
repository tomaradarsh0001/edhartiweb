        ...
        <div id="repeater" class="position-relative">
            ...
            <div class="duplicate-field-tab">
                ...
                <div class="items" data-group="coapplicant">
                    <input type="hidden" value="{{$tc->id}}" data-name="id" data-type="coapplicant">
                    <!-- Repeater Content -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="gender" id="gender" data-name="gender">
                                        ...
                                        <option value="Male" {{ $tc->co_applicant_gender == 'Male' ? 'selected' : ''
                                            }}>Male</option>
                                        <option value="Female" {{ $tc->co_applicant_gender == 'Female' ? 'selected' : ''
                                            }}>Female</option>
                                        <option value="Other" {{ $tc->co_applicant_gender == 'Other' ? 'selected' : ''
                                            }}>Other</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="mix-field">
                                        <input type="date" id="dateOfBirth" name="dateOfBirth" value="{{$tc->co_applicant_age}}" data-name="dateOfBirth" max="2006-12-26" class="form-control">
                                        <div class="age-box">
                                            <h4>Age: </h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mix-field">
                                        <select name="prefixInv" data-name="prefixInv" id="prefix" class="form-select prefix">
                                            ...
                                            <option value="S/o" {{ $tc->prefix == 'S/o' ? 'selected' : ''
                                            }}>S/o</option>
                                        <option value="D/o" {{ $tc->prefix == 'D/o' ? 'selected' : ''
                                            }}>D/o</option>
                                        <option value="Spouse Of" {{ $tc->prefix == 'Spouse Of' ? 'selected' : ''
                                            }}>Spouse Of</option>
                                        </select>
                                        <input type="text" name="secondnameInv"  value="{{$tc->co_applicant_father_name}}" data-name="secondnameInv" id="IndSecondName" class="form-control alpha-only" placeholder="Relation">
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="aadhar" class="form-control numericOnly" id="aadhar"
                                        maxlength="12" placeholder="Aadhaar Number" data-name="aadharnumber"
                                        value="{{$tc->co_applicant_aadhar}}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="coapplicant_0_aadhaarfile" class="form-label">Upload Aadhaar</label>
                                    ...
                                    <a href="{{asset('storage/' .$tc->aadhaar_file_path ?? '')}}" target="_blank"
                                        class="fs-6">View Uploaded aadhaar</a>
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pan" class="form-control pan_number_format text-uppercase"
                                        id="pan" maxlength="10" placeholder="PAN Number" data-name="pannumber"
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <a href="{{asset('storage/' .$tc->pan_file_path ?? '')}}" target="_blank"
                                        class="fs-6">View Uploaded PAN</a>
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4 d-flex justify-content-between" id="coapplicant_0">
                                <div class="form-group form-box">
                                    <label for="coapplicant_0_photo" class="form-label">Upload Photo</label>
                                    <input type="file" name="coapplicant[0][photo]" class="form-control"
                                        accept=".jpg, .jpeg, image/jpeg" data-name="photo" id="coapplicant_0_photo">
                                </div>
                                <div class="preview_img">
                                    ...
                                    <img class="preview" alt="Photo Preview"
                                        src="{{ asset('storage/' . $tc->image_path) }}" style="display: block;" />
                                    @else
                                    <img class="preview" alt="Photo Preview" />
                                    @endif
                ...
                <div class="items coapplicant-block" data-group="coapplicant">
                    <div class="item-content mb-2">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="dateOfBirth" class="quesLabel form-label">Date of Birth<span class="text-danger">*</span></label>
                                    <div class="row merge-inputs">
                                        <div class="col-lg-6">
                                            <input type="date" id="dateOfBirth" data-name="dateOfBirth"  name="dateOfBirth" max="2006-12-26" class="form-control">
                                            <span class="error-message text-danger"></span>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="age-box">
                                                <h4>Age: </h4>
                                                <input type="text" id="age" data-name="age" name="age" class="form-control" placeholder="0" readonly="">
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="row merge-inputs">
                                        <div class="col-lg-6">
                                            <select name="prefixInv" id="prefix" data-name="prefixInv" class="form-select prefix">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="secondnameInv" data-name="secondnameInv" id="IndSecondName" class="form-control alpha-only" placeholder="Relation">
                                            <span class="error-message text-danger"></span>
                                        </div>
                                    </div>
                                    <!-- <div id="IndSecondNameError" class="text-danger text-left"></div> -->
                            ...
                            <div class="col-lg-4 d-flex justify-content-between" >
                                <div class="form-group form-box">
                                    <label for="coapplicant_0_photo" class="form-label">Upload Photo</label>
                                    <input type="file" name="coapplicant[0][photo]" class="form-control"
                                        data-name="photo" accept=".jpg, .jpeg, image/jpeg" id="coapplicant_0_photo">
                                        <span class="error-message text-danger"></span>
                                </div>
                                <div class="preview_img">
                                    <input type="hidden" data-name="preview_img" class="preview_img_hidden"
