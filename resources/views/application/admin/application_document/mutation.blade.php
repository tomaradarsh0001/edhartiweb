                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered theme-table">
                                        ...
                                        <tbody>
                                                <tr>
                                                    <td colspan="4" class="document-type-row"><h4 class="doc-type-title">Required Documents</h4></td>
                                                </tr>
                                                <tr>
                                                    <td>1.</td>
                                                    <td>
                                                        <span class="doc-name">Affidavits
                                                        ...
                                                        <div class="required-info">
                                                            <ul class="required-info-list">
                                                                <li>Date of attestation: <span>07-11-2024</span></li>
                                                                <li>Attested by: <span>thtghty</span></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                    <td>
