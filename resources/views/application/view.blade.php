        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                    onclick='checkScannedFiles()'></button>
            </div>
            ...
            <div class="modal-footer justify-content-end">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                    onclick='checkScannedFiles()'>Close</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function handleApplicationAction(action, applicationNo, button, remark = null) {
        ...
        var needToconfirm = ((action == 'OBJECT' || action == 'HOLD') && remark == null);
        if (!needToconfirm) {
            ...
            if (allChecked) {
                ...
                $('#objectConfirmButton').on('click', function() {
