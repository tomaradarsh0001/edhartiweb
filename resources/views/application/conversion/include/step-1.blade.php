                            ...
                            <div class="item-content mb-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        </div> --> <!-- commented by anil and using new html code for this date of birth on 10-02-2025 -->
        ...
        <div class="row g-2 mt-2">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="convRegnoAsOnLease" class="form-control numericOnly" id="convregno" placeholder="Registration No." value="{{ isset($application) ? $application->reg_no : '' }}">
                    <div id="convregnoError" class="text-danger text-left"></div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    <label for="bookno" class="form-label">Book No.<span class="text-danger">*</span></label>
                    <input type="text" name="convBooknoAsOnLease" class="form-control numericOnly" id="convbookno" placeholder="Book No." value="{{ isset($application) ? $application->book_no : '' }}">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="convVolumenoAsOnLease" class="form-control numericOnly" id="convvolumeno" placeholder="Volume No." value="{{ isset($application) ? $application->volume_no : '' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    @endphp
                                    <input type="text" name="courtorderattestedbyConversion" class="form-control alpha-only" id="courtorderattestedbyConversion" placeholder="Issuing Authority" value="{{empty($courtOrderIssuingAuthority) ?'':$courtOrderIssuingAuthority->value }}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-mb-2">
                 <div class="col-lg-12 items">
                     <div class="row">
                         <div class="col-lg-6">
                             <div class="d-flex align-items-center">
                                <h6 class="mr-5 mb-0">Whether the Property is mortgaged?</h6>
                                <div class="form-check mr-5">
                        ...
                        <div class="col-lg-12" id="yesRemarksDivConversion" {{ isset($application) && $application->is_mortgaged ==1 ? '' : 'style=display:none;' }}>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group form-box">
                                        <label for="convMortgageeBankNOC" class="quesLabel" data-toggle="tooltip" data-placement="top" title="NOC from Mortgagee Bank/Authority">NOC from Mortgagee Bank/Authority <span><i class='bx bx-info-circle'></i></span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="NOCIssuedByConversion">Issuing Authority</label>
                                        <input type="text" name="NOCIssuedByConversion" class="form-control alpha-only" id="NOCIssuedByConversion"
                                            placeholder="Issuing Authority" value="{{!empty($NOCIssuedByConversion) ? $NOCIssuedByConversion->value:''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
