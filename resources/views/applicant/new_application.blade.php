...
<script src="{{ asset('assets/plugins/form-repeater/applicationRepeater.js') }}"></script>
    ...
    <script>
                        ...
                        if (response.data.propertyDetails) {
                            ...
                            var propertyDetailContent =
                                ...
                                `</span></td>
                                                                    ...
                                                                    formatDateToDDMMYYYY(leaseExectionDate) +
                                `</span></td>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Select all input elements with type="date" on 27-01-2025
            var dateInputs = document.querySelectorAll('input[type="date"]');


            // Set the max attribute of the date input to today's date
            document.getElementById('mutExecutedOnAsConLease').setAttribute('max', today);
            // add this bottom line for registration date of new applicant on 27-01-2025
            document.getElementById('regdate').setAttribute('max', today);
            // add this bottom line for substition/mutation second step date of execution date validation on 27-01-2025
            // document.getElementById('leaseConvDeedDateOfExecution').setAttribute('max', today);
            // add this bottom line for substition/mutation second step date of Public Notice date validation on 27-01-2025
            // document.getElementById('publicNoticeDateEnglish').setAttribute('max', today);
            // document.getElementById('publicNoticeDateHindi').setAttribute('max', today);


            // Set the max attribute to today's date for each input on 27-01-2025
                                                                ...
                                                                <div class="parent_table_container">
                                                                    <table class="table report-item">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>     
                                                                                <td>Flat Id: <span class="highlight_value">` + flatUniqueId +
                                    `</span></td>
                                                                                <td>Flat Number: <span class="highlight_value">` + flatNumber +
                                    `</span></td>
        ...
        // this funciton add by anil on 10-02-2025 for age calculation new UI or changed UI in HTML
        // $('input[data-name="dateOfBirth"]').change(function() {
        //     console.log("colled");
        ...
        //         let dob = new Date(selectedDate);
        //         let age = calculateAge(dob);
        //         console.log($(this).closest('.merge-inputs'));

        //         // Find the corresponding age input inside the same .merge-inputs parent
        //         $(this).closest('.merge-inputs').find('input[data-name="age"]').val(age);
                
        //         // Clear any existing error message
        //         $(this).closest('.merge-inputs').find('.error-message').first().html('');
        //     }
        // });
    </script>
