...
<div class="container-fluid">
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        ...
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark view-list" id="tile_total_count" data-original="{{customNumFormat($totalCount)}}">{{customNumFormat($totalCount)}}</h4>
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        ...
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark view-list" id="tile_lease_hold_count" data-original="{{customNumFormat($statusCount['lease_hold'])}}" data-filter-name="property_status" data-filter-value="951">{{customNumFormat($statusCount['lease_hold'])}}</h4>
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="d-flex align-items-center dashboard-cards">
                        ...
                        <div>
                            <h4 class="my-1 grid-icons-size text-dark view-list" id="tile_free_hold_count" data-original="{{customNumFormat($statusCount['free_hold'])}}" data-filter-name="property_status" data-filter-value="952">{{customNumFormat($statusCount['free_hold'])}}</h4>
    ...
    <div class="row custom_card_container">
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div>
                            <h4 class="my-1 text-dark view-list" id="residential_count" data-original="{{customNumFormat($propertyTypeCount['Residential'])}}" data-filter-name="property_type" data-filter-value="47">{{customNumFormat($propertyTypeCount['Residential'])}}</h4>
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div>
                            <h4 class="my-1 text-dark view-list" id="commercial_count" data-original="{{customNumFormat($propertyTypeCount['Commercial'])}}" data-filter-name="property_type" data-filter-value="48">{{customNumFormat($propertyTypeCount['Commercial'])}}</h4>
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div>
                            <h4 class="my-1 text-dark view-list" id="industrial_count" data-original="{{customNumFormat($propertyTypeCount['Industrial'])}}" data-filter-name="property_type" data-filter-value="469">{{customNumFormat($propertyTypeCount['Industrial'])}}</h4>
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div>
                            <h4 class="my-1 text-dark view-list" id="institutional_count" data-original="{{customNumFormat($propertyTypeCount['Institutional'])}}" data-filter-name="property_type" data-filter-value="49">{{customNumFormat($propertyTypeCount['Institutional'])}}</h4>
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div>
                            <h4 class="my-1 text-dark view-list" id="mixed_count" data-original="{{customNumFormat($propertyTypeCount['Mixed'])}}" data-filter-name="property_type" data-filter-value="72">{{customNumFormat($propertyTypeCount['Mixed'])}}</h4>
            ...
            <div class="card radius-10 border-start border-0">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <div>
                            <h4 class="my-1 text-dark view-list" id="others_count" data-original="{{customNumFormat($propertyTypeCount['Others'])}}" data-filter-name="property_type" data-filter-value="1353">{{customNumFormat($propertyTypeCount['Others'])}}</h4>
...
<script>
    ...
    $('.view-list').click(function() {
        ...
        let url = `{{ route("detailedReport") }}?${queryString}`;
