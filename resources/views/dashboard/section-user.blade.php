        ...
        <div class="container-fluid dashboardcards">
            <div class="row">
                        ...
                        <div class="card offorangecard totalApp" style="margin-bottom: 0px;">
                            <div class="card-body">
                                <div class="dashboard-card-view">
                                    <h4><a href="{{ route('admin.applications') }}" style="color: inherit">Total Applications:
                ...
                <div class="col-lg-4 col-12">
                    <div class="col-lg-12 col-12" style="margin-bottom: 0px;">
                        ...
                        <h4 class="pubser-title"><a href="{{ route('applicantNewProperties') }}" style="color: inherit">Public Services:
                                        ...
                                        <a href="{{ route('grievance.index') }}">
                                            <div class="public-services-content">
                                             <div class="services-label">
                                                 <img src="{{ asset('assets/images/WhyGrievances.svg') }}" alt="Grievances" class="grievance-icon">
                                                 <h4>Grievances</h4>
                                             </div>
                                             <div class="services-count">
                                                 <h4 class="services_count_text"><span id="appointmentCount">{{$grievencesCount}}</span></h4>
                                             </div>
                                            </div>
                                         </a>
                                    </div>
                                    <div class="grievance-card-item">
                                        <a href="{{ route('appointments.index') }}">
                                            <div class="public-services-content">
                                             ...
                                             <div class="services-count">
                                                 <h4 class="services_count_text"><span id="grievencesCount">{{$appointmentCount}}</span></h4>
                                             </div>
                                            </div>
                                         </a>
                                    </div>
            ...
            <div class="col-lg-4 col-12">
                <div class="card darkbluecard landusechange">
                    <div class="card-body">
                        <h4>Land Use Change: <span id="luc-total">{{ isset($lucData['total']) ? $lucData['total'] : 0 }}</span></h4>
                        <div class="styled-table">
                            @foreach ($statusList as $i => $status)
                            <div class="table-item">
                                <span>
                                ...
                                <div class="value"><span id="luc-{{ $status->item_code }}">{{ isset($lucData[$status->item_code]) ? $lucData[$status->item_code] : 0 }}</span></div>
